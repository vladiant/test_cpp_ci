...
//   EXPECT_EQ_THROWS_AS(utest_fixture->warper_.addition(a, b),
//   std::overflow_error);
// }
...
//   constexpr auto a = kMinValue;
//   constexpr int16_t b = 1;
//   EXPECT_EQ_THROWS_AS(utest_fixture->warper_.subtraction(a, b),
//   std::underflow_error);
// }
...
//   EXPECT_EQ_THROWS_AS(utest_fixture->warper_.multiplication(a, b),
//   std::overflow_error);
// }
